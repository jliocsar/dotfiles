...
import { EntryPage, ListPage, MissingPage } from '../pages/Entries.tsx'
import { page, respond } from '../render.ts'
import { EntrySlug, NAV, sectionOf, ShareLinkId, ShareToken, ShareTtl } from '../domain.ts'
...
const listRoute = (section: Section) =>
  Effect.gen(function* () {
    ...
    return yield* page(ListPage({ section, archived: params['archived'] !== undefined }))
  })
